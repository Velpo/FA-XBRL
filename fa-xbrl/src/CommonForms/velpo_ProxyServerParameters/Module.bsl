...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If ProxySettingsAtClient Then
		ProxyServerSettings = velpo_GetFilesFromInternet.ProxySettingsAtClient();
	Else
...
Procedure ChoiceProcessing(SelectedValue, ChoiceSource)
	...
	If Upper(ChoiceSource.FormName) = Upper("CommonForm.velpo_AdditionalProxyServerParameters") Then
...
Procedure AdditionalProxyServerParameters(Command)
	...
	OpenForm("CommonForm.velpo_AdditionalProxyServerParameters", FormParameters, ThisObject);
...
Procedure WriteProxyServerSettingsToInfobase(ProxySettingsAtClient, ProxyServerSettings)
	...
	//Else
		velpo_GetFilesFromInternetInternal.SaveServerProxySettings(ProxyServerSettings);
	//EndIf;
