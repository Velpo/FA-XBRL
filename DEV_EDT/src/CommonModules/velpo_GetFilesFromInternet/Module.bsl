...
Function DownloadFileAtServer(Val URL, ReceivingParameters = Undefined, Val WriteError = True) Export
	...
	ReceivingSettings = velpo_GetFilesFromInternetClientServer.FileAcquisitionParameterStructure();
	...
	Return velpo_GetFilesFromInternetClientServer.PrepareFileReceiving(URL,
...
Function ProxySettingsAtClient() Export
	...
	Return velpo_CommonFunctions.CommonSettingsStorageLoad("velpo_ProxyServerSettings");
...
Function ProxySettingsAtServer() Export
	...
	ProxySettingsAtServer = Constants.velpo_ProxyServerSettingsttings.Get().Get();
